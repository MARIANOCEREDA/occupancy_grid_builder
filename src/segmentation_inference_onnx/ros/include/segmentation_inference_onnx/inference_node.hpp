 ...
 */
inline const std::map<std::string, yolo_onnx_inference::DeviceType> device_type_map = {
    {"CPU", yolo_onnx_inference::DeviceType::CPU}, {"GPU", yolo_onnx_inference::DeviceType::GPU}};
 ...
 */
class InferenceNode : public rclcpp_lifecycle::LifecycleNode
{
 public:
  /**
   * @brief Construct a new InferenceNode.
 ...
 private:
  ...
  std::shared_ptr<yolo_onnx_inference::YoloONNXInference> detector_;

...
build-all-cpp: build-camera-lidar-fusion-cpp build-occupancy-grid-builder-cpp
	@echo ""
	@echo "╔════════════════════════════════════════════════════════════════════════════╗"
...
clean-all-cpp: clean-camera-lidar-fusion-cpp clean-occupancy-grid-builder-cpp
